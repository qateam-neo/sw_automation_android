...
def ContinueReg_ThankYouScreen(driver, ReportDriver):
    TestCase ="(Continue Registration) Thank You Screen"
    Status =True

    ContinueRegistrationButton =driver.find_element(By.ID,"neo.nbkc.smartwealth.demo:id/continueButton")
...
def ContinueReg_ThankYouScreen_Detailed(driver, ReportDriver):
    TestCase ="(Continue Registration) Thank You Screen"
    Status =True
    ...
    Text2Expected ="You are now signed upssss"
    ...
    Text3Expected = "Continue setting up your account to start your investment journey today.sss"
    if (( Text3Expected != Text3)):
        Status=False
        ReportResults(ReportDriver,driver,Status,TestCase,Text3,Text3Expected)

    ContinueRegistrationButton =driver.find_element(By.XPATH,"/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.Button")
    Text5 =ContinueRegistrationButton.text
    Text5Expected1 = "Continue Registration"
